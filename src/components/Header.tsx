...
const Header = () => {
  ...
  return (
    <header className="bg-white sticky top-0 z-[999] py-[clamp(1rem,2.5vw,1.25rem)] border-b border-[#0d1b34]/5 backdrop-blur-[10px] transition-all duration-[400ms] ease-out">
